...
GRANT ALL PRIVILEGES ON TABLE categories TO labelforge_user;
GRANT USAGE, SELECT ON SEQUENCE categories_id_seq TO labelforge_user;

-- Insert default categories
INSERT INTO categories (name) VALUES
  ('Ladoo'), ('Flour'), ('Farsan'), ('Masala'), ('Other')
...
GRANT ALL PRIVILEGES ON TABLE settings TO labelforge_user;

-- Default GS1 prefix (internal use range)
INSERT INTO settings (key, value) VALUES
  ('ean.company.prefix', '20001')
